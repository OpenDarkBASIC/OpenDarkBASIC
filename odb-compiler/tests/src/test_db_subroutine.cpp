...
TEST_F(NAME, declare_sub)
{
    ...
    ASSERT_THAT(block->block.statement->sym.label.flag.datatype, Eq(SDT_NONE));
    ...
    ASSERT_THAT(block->block.statement->sym.func_call.flag.datatype, Eq(SDT_NONE));
...
TEST_F(NAME, call_sub)
{
    ...
    ASSERT_THAT(block->block.statement->sym.sub_call.flag.datatype, Eq(SDT_NONE));
