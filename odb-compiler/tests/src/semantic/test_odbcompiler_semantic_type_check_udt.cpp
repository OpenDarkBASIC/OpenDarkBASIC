...
TEST_F(NAME, decl)
{
    ...
    ASSERT_THAT(ast->nodes[as_type1].as_type.type, Eq(TYPE_I32));
    ...
    ASSERT_THAT(ast_type_info(ast, as_type1), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, decl12), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, decl23), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, block4), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, ident5), Eq(TYPE_F32));
    ASSERT_THAT(ast_type_info(ast, as_type6), Eq(TYPE_F32));
    ASSERT_THAT(ast_type_info(ast, decl17), Eq(TYPE_F32));
    ASSERT_THAT(ast_type_info(ast, decl28), Eq(TYPE_F32));
    ASSERT_THAT(ast_type_info(ast, block9), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, ident10), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, udt_decl11), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, block12), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, lit13), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, lit14), Eq(TYPE_F32));
    /* odb-asttool end */
}
...
TEST_F(NAME, as_udt)
{
    ...
    ASSERT_THAT(ast_type_info(ast, udt_decl11), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, block12), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, ident13), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, as_udt14), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, decl115), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, decl216), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, block17), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, lit18), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, lit19), Eq(TYPE_F32));
    ASSERT_THAT(ast_type_info(ast, lit20), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, arglist21), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, lit22), Eq(TYPE_F32));
    ASSERT_THAT(ast_type_info(ast, arglist23), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, udt_init24), Eq(TYPE_UDT_PTR));
    /* odb-asttool end */
}
...
TEST_F(NAME, read_udt_field)
{
    ...
    ASSERT_THAT(ast_type_info(ast, decl216), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, block17), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, ident18), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, decl219), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, ident20), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, var_read21), Eq(TYPE_UDT_PTR));
    ASSERT_THAT(ast_type_info(ast, ident22), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, var_read23), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, udt_read24), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, decl125), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, block26), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, lit27), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, lit28), Eq(TYPE_F32));
    ASSERT_THAT(ast_type_info(ast, lit29), Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, arglist30), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, lit31), Eq(TYPE_F32));
    ASSERT_THAT(ast_type_info(ast, arglist32), Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, udt_init33), Eq(TYPE_UDT_PTR));
    /* odb-asttool end */
}
