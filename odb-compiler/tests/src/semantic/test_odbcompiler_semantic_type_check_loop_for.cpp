...
TEST_F(NAME, implicit_step_1)
{
    ...
    ASSERT_THAT(ast->nodes[as_type25].as_type.type.primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast->nodes[as_type27].as_type.type.primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast->nodes[as_type29].as_type.type.primitive, Eq(TYPE_I32));

    ASSERT_THAT(ast_type_info(ast, ident0).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, decl21).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, lit2).primitive, Eq(TYPE_U8));
    ASSERT_THAT(ast_type_info(ast, decl13).primitive, Eq(TYPE_I32));
    ...
    ASSERT_THAT(ast_type_info(ast, ass8).primitive, Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, binop9).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, loop1_10).primitive, Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, loop2_11).primitive, Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, block12).primitive, Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, exit13).primitive, Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, block14).primitive, Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, branches15).primitive, Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, ident16).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, var_read17).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, binop18).primitive, Eq(TYPE_BOOL));
    ASSERT_THAT(ast_type_info(ast, cond19).primitive, Eq(TYPE_VOID));
    ASSERT_THAT(ast_type_info(ast, ident20).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, var_write21).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, lit22).primitive, Eq(TYPE_U8));
    ASSERT_THAT(ast_type_info(ast, ident23).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, var_read24).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, as_type25).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, cast26).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, as_type27).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, cast28).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, as_type29).primitive, Eq(TYPE_I32));
    ASSERT_THAT(ast_type_info(ast, cast30).primitive, Eq(TYPE_I32));
    /* odb-asttool end */
}
