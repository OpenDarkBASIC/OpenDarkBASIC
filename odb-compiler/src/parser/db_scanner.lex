...
<INITIAL>{
    ...
    {STRING_LITERAL}    { yylval->string_value = cstr_utf8_ref(yytext); RETURN_TOKEN(TOK_STRING_LITERAL); }
    ...
    {IDENTIFIER}        { yylval->string_value = cstr_utf8_ref(yytext); RETURN_TOKEN(TOK_IDENTIFIER); }
