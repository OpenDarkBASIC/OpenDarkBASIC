...
public:
    ...
    virtual void visitUDTTypeDecl(UDTTypeDecl* node) = 0;
    virtual void visitUDTTypeDeclBody(UDTTypeDeclBody* node) = 0;
    virtual void visitUDTTypeRef(UDTTypeRef* node) = 0;
    virtual void visitUDTTypeRefSymbol(UDTTypeRefSymbol* node) = 0;
...
public:
    ...
    virtual void visitUDTTypeDecl(const UDTTypeDecl* node) = 0;
    virtual void visitUDTTypeDeclBody(const UDTTypeDeclBody* node) = 0;
    virtual void visitUDTTypeRef(const UDTTypeRef* node) = 0;
    virtual void visitUDTTypeRefSymbol(const UDTTypeRefSymbol* node) = 0;
...
public:
    ...
    void visitUDTTypeDecl(UDTTypeDecl* node) override;
    void visitUDTTypeDeclBody(UDTTypeDeclBody* node) override;
    void visitUDTTypeRef(UDTTypeRef* node) override;
    void visitUDTTypeRefSymbol(UDTTypeRefSymbol* node) override;
