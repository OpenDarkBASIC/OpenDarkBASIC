...
#define X(dbname, cppname) virtual void visit##dbname##VarDecl(const dbname##VarDecl* node) = 0;
    ODB_DATATYPE_LIST
#undef X
};
...
#define X(dbname, cppname) void visit##dbname##VarDecl(const dbname##VarDecl* node) override;
    ODB_DATATYPE_LIST
#undef X
