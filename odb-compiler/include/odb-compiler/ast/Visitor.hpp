...
public:
    ...
    virtual void visitUDTArrayAssignment(const UDTArrayAssignment* node) = 0;
    ...
    virtual void visitUDTArrayRef(const UDTArrayRef* node) = 0;
...
public:
    ...
    void visitUDTVarRef(UDTVarRef* node) override;
...
public:
    ...
    void visitUDTArrayAssignment(const UDTArrayAssignment* node) override;
    ...
    void visitUDTArrayRef(const UDTArrayRef* node) override;
