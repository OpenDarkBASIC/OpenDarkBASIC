...
static const Action actions_[] = {
    ...
    { "color",          0, "",                           {0,  0},  0, false,  &enableColor, "Enables color escape sequences for all messages"},
    ...
    { "version",        0, "",                           {0,  0},  2, false,  &printVersion, "Prints the version"},
    ...
    { "output-type",    0, "<obj|exe|llvm-ir|llvm-bc>",  {1,  1},  8, false,  &setOutputType, "Specify the file type generated by the --output flag. Can be either an executable, object file, LLVM IR or LLVM bitcode. Defaults to 'object'."},
    { "output",        'o',"[file]",                     {1,  1},  9, false,  &output, "Output file."},
};
// clang-format on
