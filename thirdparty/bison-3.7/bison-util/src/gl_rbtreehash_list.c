...
/* Specification.  */
#include "bison-util/gl_rbtreehash_list.h"

#include <stdint.h> /* for uintptr_t, SIZE_MAX */
#include <stdlib.h>

#include "bison-util/gl_rbtree_oset.h"
#include "bison-util/xsize.h"
...
#include "bison-util/gl_anyhash1.h"

/* Generic red-black tree code: Type definitions.  */
#include "bison-util/gl_anyrbtree_list1.h"
