...
#include "bison-util/configmake.h" /* PKGDATADIR */
#include "bison-util/dirname.h"
#include "bison-util/error.h"
#include "bison-util/get-errno.h"
#include "bison-util/gl_array_list.h"
#include "bison-util/gl_xlist.h"
#include "bison-util/quote.h"
#include "bison-util/quotearg.h"
#include "bison-util/relocatable.h" /* relocate2 */
#include "bison-util/stdio-safer.h"
#include <sys/stat.h>
#include <sys/types.h>
#include <unistd.h>
#include "bison-util/xstrndup.h"
...
m4path (void)
{
  ...
  char const *m4_relocated = relocate ("/usr/bin/m4");
  struct stat buf;
