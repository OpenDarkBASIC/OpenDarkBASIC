...
%code
{
  ...
  #include "bison-util/c-ctype.h"
  #include <errno.h>
  #include "bison-util/intprops.h"
  #include "bison-util/quotearg.h"
  #include "bison-util/vasnprintf.h"
  #include "bison-util/xmemdup0.h"
